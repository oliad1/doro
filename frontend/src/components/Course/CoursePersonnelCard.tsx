...
export default function CoursePersonnelCard({
  data,
}: CoursePersonnelCardProps) {
  return (
    <Card className="w-full h-min">
      <CardHeader>
        <CardTitle>Course Personnel</CardTitle>
        <CardDescription>
          All important personnel related to this course.
        </CardDescription>
      </CardHeader>
        ...
        {data.map((person, i) => {
          ...
          return (
            ...
            >
              ...
              <Badge variant={isProf ? "default" : "secondary"}>
                {person.role}
              </Badge>
            </div>
          );
