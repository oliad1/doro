...
export default function DashboardSidebar({ user, loading }: SidebarProps) {
  ...
  const { termCourses, term, setTerm, fetchTermCourses, deleteTermCourse } =
                    ...
                    >
                      <div>
                        ...
                        {item.beta && (
                          <Badge
                            variant="secondary"
                            className="bg-[var(--primary)]/30 py-0 rounded-md"
                          >
                            beta
                          </Badge>
                        )}
                        ...
                        <SidebarMenuItem className="w-full">
                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent side="right" align="start">
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  exportCalendar(course.id, course.code)
                                }
                              >
                                <Calendar />
                                Export Calendar
                            ...
                            <AlertDialogAction
                              onClick={() => {
                                if (pathname.includes(course.id)) {
                                  ...
                                  router.push(
                                    termCourses.length > 1
                                      ? `/course/${termCourses[nextId].id}`
                                      : `/home`,
                                  );
                                }
                ...
                >
                  {!isPending ? (
                    <>
                      ...
                      {open && <ChevronsUpDown className="size-4" />}
                    </>
                  ) : (
